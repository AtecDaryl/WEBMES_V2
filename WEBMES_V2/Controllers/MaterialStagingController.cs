...
namespace WEBMES_V2.Controllers
{
    ...
    public class MaterialStagingController : Controller
    {
        ...
        public async Task<IActionResult> MaterialHistory()
        {
            return View();
        }

        public async Task<IActionResult> _MaterialHistoryTable(StageLot stageLot)
        {
            var historyList = await _materialRepository.GetMaterialStagingHistoryDTOs(stageLot);
