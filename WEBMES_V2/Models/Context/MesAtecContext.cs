...
public partial class MesAtecContext : DbContext
{
    ...
    public virtual DbSet<TrnMachinePerStage> TrnMachinePerStages { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TrnMachinePerStage>(entity =>
       {
           entity.HasKey(e => e.Id).HasName("PK__Trn_Mach__3214EC0769B66766");
           entity.ToTable("Trn_MachinePerStage");
       
           entity.Property(e => e.Id).ValueGeneratedOnAdd(); // Ensure EF Core recognizes Id as auto-generated
           entity.Property(e => e.MachineId).HasMaxLength(255);
           entity.Property(e => e.TrackOutDateTime).HasColumnType("datetime");
           // Add configuration for other properties if needed
       });
