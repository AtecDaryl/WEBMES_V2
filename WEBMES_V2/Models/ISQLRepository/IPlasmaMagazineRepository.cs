...
namespace WEBMES_V2.Models.ISQLRepository
{
    public interface IPlasmaMagazineRepository
    {
        ...
        Task<Boolean> CheckMachineIfExist(Trn_InsertMachineDTO Trn_InsertMachineDTO);
        Task<int> InsertGetMachine(Trn_InsertMachineDTO Trn_InsertMachineDTO);
        ...
        Task<Boolean?> CheckMachineExceed15Mins(StageLot stageLot);
    }
}
